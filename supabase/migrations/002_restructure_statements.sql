-- =============================================================================
-- 002_restructure_statements.sql
-- Almacenamiento de estados de cuenta en dos capas:
--
...
--                     al estado de cuenta. Aquí vive la categoría y el concepto
--                     normalizado.
-- =============================================================================
...
create table if not exists public.statements (
  ...
  transacciones_raw   jsonb not null default '[]',
...
--    Ingesta atómica: statement + N transacciones en una sola transacción de BD.
--    SECURITY INVOKER → respeta RLS; user_id se toma de auth.uid().
-- ----------------------------------------------------------------------------
